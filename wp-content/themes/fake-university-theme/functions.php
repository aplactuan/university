...
add_filter('wp_insert_post_data', 'fake_university_make_not_private', 10, 2);
function fake_university_make_not_private($data, $postArr) {
    if ($data['post_type'] == 'note') {
        if (count_user_posts(get_current_user_id(), 'note') > 4 AND !$postArr['ID']) {
            die("You have reach your limit");
        }
